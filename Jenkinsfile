node {
   ...
   stage('copy_file'){
      ...
      sh 'scp -r first.yml tsv@192.168.0.131:/home/tsv/CI-CD/'
      sh 'scp -r p_docker_restart.yml tsv@192.168.0.131:/home/tsv/CI-CD/'
   }
   stage('start_playbook'){
      sh 'ssh tsv@192.168.0.131 \'ansible-playbook /home/tsv/CI-CD/first.yml\' '
   }
//    stage('start_job_git'){
